...
//    DFontSizeManager::instance()->bind(m_tips, DFontSizeManager::T6);
    m_tips->setForegroundRole(QPalette::ToolTipText);
    m_tips->hide();

    QPushButton *button = new QPushButton(tr("Open Image"), this);
...
//                     this, &HomePageWidget::ThemeChange);
    ...
    QObject::connect(button, &QPushButton::clicked, this, &HomePageWidget::openImageInDialog);
