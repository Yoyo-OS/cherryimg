...
void LibViewPanel::initScaleLabel()
{
    ...
    QWidget* scalePerc = new QWidget(this);
...
void LibViewPanel::initRightMenu()
{
    ...
    connect(m_menu, &QMenu::triggered, this, &LibViewPanel::onMenuItemClicked);
}
...
//        }
        ...
        QToolButton *AdaptImageButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypeAdaptImage);
        QToolButton *AdaptScreenButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypeAdaptScreen);
        ...
        //ocr按钮,是否是动态图,todo
        QToolButton *OcrButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypeOcr);
        ...
        if (isAlbum && isReadable) {
            ...
            //不管有无自定义相册，均需保留添加到相册
            QMenu *am = new QMenu(tr("Add to album"), m_menu);
        ...
        QToolButton *TrashButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypeTrash);
...
QToolButton *LibViewPanel::getBottomtoolbarButton(imageViewerSpace::ButtonType type)
{
...
{
    QToolButton *NextButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypeNext);
...
{
    QToolButton *PreviousButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypePre);
...
void LibViewPanel::initShortcut()
{
    ...
    connect(sc, &QShortcut::activated, this, [ = ] {
        if (m_stack->currentWidget() != m_sliderPanel)
        {
            QToolButton *PreButton = m_bottomToolbar->getBottomtoolbarButton(imageViewerSpace::ButtonTypePre);
