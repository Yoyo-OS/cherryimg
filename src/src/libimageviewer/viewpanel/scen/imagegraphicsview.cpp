...
void LibImageGraphicsView::initMorePicWidget()
{
    ...
    connect(m_morePicFloatWidget->getButtonUp(), &QToolButton::clicked, this, &LibImageGraphicsView::slotsUp);
    connect(m_morePicFloatWidget->getButtonDown(), &QToolButton::clicked, this, &LibImageGraphicsView::slotsDown);
