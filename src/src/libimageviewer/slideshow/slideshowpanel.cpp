...
SlideShowBottomBar::SlideShowBottomBar(QWidget *parent) : QWidget(parent)
{
    ...
    hb->addSpacing(4);
    connect(m_preButton, &QToolButton::clicked, this, &SlideShowBottomBar::onPreButtonClicked);
    ...
    hb->addSpacing(4);
    connect(m_playpauseButton, &QToolButton::clicked, this, &SlideShowBottomBar::onPlaypauseButtonClicked);
    //todo屏蔽了全局信号
...
//    connect(dApp->signalM, &SignalManager::initSlideShowButton, this, &SlideShowBottomBar::onInitSlideShowButton);
    ...
    hb->addSpacing(4);
    connect(m_nextButton, &QToolButton::clicked, this, &SlideShowBottomBar::onNextButtonClicked);
    ...
    connect(m_cancelButton, &QToolButton::clicked, this, &SlideShowBottomBar::onCancelButtonClicked);
    setLayout(hb);
}
