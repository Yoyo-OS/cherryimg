...
void PrintHelper::showPrintDialog(const QStringList &paths, QWidget *parent)
{
    ...
    QPrintPreviewDialog printDialog2(parent);
...
//    }
//#endif
    connect(&printDialog2, SIGNAL(paintRequested(QPrinter *)),
            m_re, SLOT(paintRequestSync(QPrinter *)));
...
void RequestedSlot::paintRequestSync(QPrinter *_printer)
{
